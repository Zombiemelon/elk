pipeline {
    ...
    stages {
        stage ('Build Back') {
            steps {
                sh "docker build -t $CONTAINER_NAME:back -f ./docker/elasticsearch/Dockerfile.elasticsearch . "
            }
        }
